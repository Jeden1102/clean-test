                    ...
                    <div class="w-full  my-6 pr-0 lg:pr-2">
                        ...
                        <div class="leading-loose card">
                            <form class="p-10 bg-white rounded shadow-xl">
                                    ...
                                    <input class="w-full mt-2 lg:w-1/2 px-5 py-1 text-gray-700 bg-gray-200 rounded lokalizacja" id="name" name="name" type="text" required="" placeholder="Login123" aria-label="Name">                               </div>
                            </form>
                            <div class="card">
                            <table class='min-w-full bg-white'>
                                <thead class='bg-gray-800 text-white'>
                                    <tr>
                                        ...
                                        <th class='w-20 text-left py-3 px-4 uppercase font-semibold text-sm text-center'>Ilość zleceń</th>
