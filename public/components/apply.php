          ...
          <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            ...
            <div class="mt-2">
              <p class="text-sm text-gray-500">
                Aby zrestartować hasło podaj adres e-mail podany do Twojego konta. Wiadomość z dalszymi intrukcjami zostanie wysłana na Twoją skrzynkę.
              </p>
              <form action="../../back/forgotpwd.php" method="POST">
              <input name="mail" type="email" class="form-control mt-4" id="exampleFormControlInput1" placeholder="name@example.com">
            </div>
          </div>
        </div>
      </div>
      <div class="border-t-2 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
        <button name="send" type="submit" id="btn-change" class="mt-3 bg-green-400 hover:bg-green-500 w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
          Przywróć
        </button>
