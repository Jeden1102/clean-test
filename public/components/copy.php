         ...
         if(empty($jsonActiveOrders)){
           ...
           echo '<h2 class="text-center text-2xl my-4">Nie masz żadnych aktywnych ofert</h2>';
             ...
             foreach ($jsonActiveOrders as $value){
               ...
               <div class=' w-11/12 card  mx-auto my-2 md:flex md:flex-row-reverse h-full'>
                 <!--ZDJĘCIE-->
                   ...
                   if(empty($json_user_applied)){
                     ...
                     if(is_null($value['chosen_user'])){
                      ...
                      foreach($json_user_applied as $value2){
                       ...
                       echo "
                       <div class='ml-4'>Wybrałeś usera : " .  $value['chosen_user'] . "</div>
         ...
         if(empty($jsonEndedOrders)){
           ...
           echo '<h2 class="text-center text-2xl my-4">Nie masz żadnych aktywnych ofert</h2>';
             ...
             foreach ($jsonEndedOrders as $value){
               ...
               <div class=' card w-11/12  mx-auto my-2 md:flex md:flex-row-reverse h-full'>
                 <!--ZDJĘCIE-->
                 <div class='md:w-1/3  w-full mx-auto rounded  h-60' style='background-image:url($img);background-size:cover;background-position:center'>
                 ...
                 <div class='mt-4 md:w-2/3 h-1/3 md:h-full'>
                   ...
                   <div class='buttons ml-4'>
                   <a  href='../views/ogloszenie.php?id=" .  $value['order_id'] . "' class='mt-4 next-step  inline-flex justify-center py-2 px-4  shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500' href='./public/views/ogloszenia.php'>Podgląd oferty</a>
                   </div>
                   </div>
                    </div>
                 </div>
